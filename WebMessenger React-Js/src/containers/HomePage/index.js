    ...
    <Layout>
      ...
      <section className="container">
        ...
        <div className="displayName">
                ...
                <div style={{display: 'flex' ,flex: 1, justifyContent: 'space-between', margin: '0 10px'}}>
                    <span style={{fontWeight: 500}}><div>Virtual Interview Platform</div><div>@Creater</div></span>
        ...
        <div className="chatArea">
            <div className="chatHeader">
             {   chatStarted ? chatUser : 'Virtual Interview Platform @ Creater @ Contact Us @ preritkrjha@gmail.com' }
            </div>
